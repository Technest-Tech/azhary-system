        ...
        <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px;">
            ...
            <div>
                <h2 style="font-size: 20px; font-weight: 700; color: #1e293b; margin-bottom: 4px;">
                    <i class="fas fa-user-plus" style="color: #14b8a6; margin-right: 8px;"></i>
                    Add New Student
                </h2>
        ...
        <form method="POST" action="{{ route('admin.students.store') }}">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div>
                    ...
                    <input type="number" name="package_number" value="{{ old('package_number', 1) }}" required min="1"
                        style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px;"
                        placeholder="1">
                ...
                <div>
                    ...
                    <input type="number" name="package_rate" value="{{ old('package_rate', '200.00') }}" required min="0" step="0.01"
                        style="width: 100%; padding: 12px 16px; border: 1px solid #e2e8f0; border-radius: 8px; font-size: 14px;"
                        placeholder="200.00">
                    @error('package_rate')
                        <span style="color: #dc2626; font-size: 13px; margin-top: 4px; display: block;">{{ $message }}</span>
